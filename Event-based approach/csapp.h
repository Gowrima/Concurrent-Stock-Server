...
/* Added by 20181603 Kim Minseon */
typedef struct item{ /* stock table */
	int id;				/* stock id */
	int left_stock;		/* left # of stocks */
...
sem_t w;			/* Protects accesses to stock_table */
sem_t mutex;		/* Protects accesses to readcnt */
int readcnt;		/* Counts # of current readers */
